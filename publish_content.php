...
<!--        <header class="section-header">
        ...
        <div class="row text-autoridades">
             ...
             <?php 
              require_once './conexion/conexion.php';
              require_once './clases/publicaciones.php';
              if (isset($_GET['idpublish'])) {
                  $publicaciones=new publicaciones();
                  $publicaciones->obtener_publicacion($_GET['idpublish']);
                  $publicaciones->vistas($_GET['idpublish']);
              }
              ?>
...
<!--    <section id="contact">
  ...
  <link href="css/publicaiones.css" rel="stylesheet">
...
//        console.log(posx+ancho_img);
    ...
    $('.conten_publish img').hover(function() {
    $(this).css('width','100%');
});
    });
</script>
