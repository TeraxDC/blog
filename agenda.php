...
demo
  ...
  <main id="main">
    ...
    <section id="about" class="p-3 mt-3">
      <h1 class="d-inline"><b>AGENDA ALCALDIA</b> </h1>
      <h1 class="text-info d-inline center"><b>2023-2026</b></h1>
      
        <div class="row">
          
          <iframe class="col-lg-12 col-md-12 col-sm-12 p-4" src="https://calendar.google.com/calendar/embed?height=640&wkst=2&bgcolor=%234285F4&ctz=America%2FLima&showPrint=1&showDate=1&showTitle=0&showTabs=1&showCalendars=0&title=Agenda%20Alcaldia%20-%20MPH&src=azJndGk2OG5jbnFsamE3dWFscGR1c3B2azRAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ&color=%234285F4" style="border-width:0" width="1000" height="640" frameborder="0" scrolling="no"></iframe>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Plaza Principal<br>
              Huancavelica <br>
              <strong>Tel:</strong> +51 973 015 142<br>
              <strong>Email:</strong> mesadepartes@munihuaytara.gob.pe <br> contacto@munihuaytara.gob.pe<br>
            </p>
