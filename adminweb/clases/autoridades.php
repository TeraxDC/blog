...
class autoridad
{
    public function lista_tablas()
    {
        try {
            ...
            $sql = "SELECT a.id, a.nombre, a.correo, a.descripcion, a.cargo idcargo, c.nombre cargo, a.gestion idgestion, concat(g.inicio, ' - ',g.fin) gestion, a.foto from autoridad a 
