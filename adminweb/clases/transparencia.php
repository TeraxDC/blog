...
$sql="SELECT transparencia.idtransparencia,transparencia.idcattrans, cat_transparencia.nombre,transparencia.nombre_transparencia,
transparencia.descripcion_breve,transparencia.create_time,transparencia.update_time,concat('../docs_transparencia/',transparencia.archivo_adjunto)
FROM transparencia 
inner join cat_transparencia on transparencia.idcattrans=cat_transparencia.idcat_docs_gestion
