												...
												<div class="row">
													...
													<div class="col-sm-12">
														<div class="form-group">
                                                                                                                    ...
                                                                                                                    <label for="nombre_menu" class="blue bolder">Nombre Menu:</label>
															<div>
                                                                                                                            <input type="text" class="form-control" id="nombre_menu" placeholder="Nombre del Menú de Acceso"  />
                                                                                                                            <label class="red bolder hide" id="nombre_menuvalidate">Nombre del Menú es Obligatorio   *</label>
															</div>
                                                                                                                    </div>
                                                                                                                    <label for="direccion" class="blue bolder">Dirección de Archivo:</label>
															<div>
																<input type="text" class="form-control" id="direccion" placeholder="vistas/ejemplo.php"  />
                                                                                                                                <label  class="red bolder hide" id="direccionvalidate">La Dirección es Obligatoria *</label>
															</div>
                                                                                                                    <label for="clase" class="blue bolder">Clase a LLamar:</label>
															<div>
																<input type="text" class="form-control" id="clase" placeholder="Mantenimiento"  />
															</div>
                                                                                                                    <label for="icono_fa" class="blue bolder">Icono fa fa-icon:</label>
															<div>
																<input type="text" class="form-control" id="icono_fa" placeholder="fa fa-icon"  />
															</div>
                                                                                                                    <label for="direccion" class="blue bolder">Dependencia:</label>
															<div>
																<select class="chosen-select form-control" id="list_menus" data-placeholder="Escoja una Dependencia...">
																<option value="">  </option>
																<?php
                                                                                                                                    $dml_menu->lista_menu();
                                                                                                                                ?>
...
//                        alert(valores[0]);
                        ...
                        if (respuesta){
                          var parametros={"Eliminar":"-",
                                           "codigoe":valores[0]};
                            eliminar_datos(parametros,"../clases/menus.php","post");
                        }
