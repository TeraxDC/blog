...
<html lang="es">
	<head>
		...
		<meta name="MUNI WEB ADMINISTRACION" content="CONFIGURACION ACCESOS" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                                                <div class="row">
                                                                    <form action="v_acces_users.php" method="POST">
                                                                    <div class="col-sm-10 col-lg-11">
                                                                    
                                                                        
                                                                        <select class="chosen-select form-control" id="usuario" name="usuario" data-placeholder="Escoja un Usuario">
                                                                            <option value="">  </option>
									<?php
                                                                                require_once '../clases/Acces_users.php';
                                                                                $dml_acces_list->lista_usuarios();
                                                                          ?>
									</select>
                                                                    </div>
                                                                                                                                    ...
                                                                                                                                    <div class="table-header">
                                                                                                                                        ...
                                                                                                                                        <table id="tabla_datos" class="table table-striped table-bordered table-hover ">
                                                                                                                                                ...
                                                                                                                                                <tbody>
                                                                                                                                                    <?php
                                                                                                                                                    if (isset($_POST["usuario"])) {
                                                                                                                                                        $dml_acces_list->lista_datos($_POST["usuario"]);
                                                                                                                                                                     }
...
//                        alert(valores[0]);
                        ...
                        if (respuesta){
                          var parametros={"Eliminar":"-",
                                           "codigoe":valores[0]};
                            eliminar_datos(parametros,"../clases/Acces_users.php","post");
                        }
                    ...
                    $(".permitir").click(function(){
                        ...
                        i++;
                                    ...
                                    var idusuario="<?php if (isset($_POST['usuario'])) {echo $_POST['usuario'];}else{echo "";} ?>";
                                    var idmenu=valores[1];
                                    var parametros={"Insertar":"-",
                                                    "idusuario":idusuario,
                                                    "idmenu":idmenu};
                                    $.ajax({
                                        data:  parametros,
                                        url:   "../clases/Acces_users.php",
                                        type:  "post",
