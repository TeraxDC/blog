...
<label for="inicio" class="blue bolder">Año de Inicio:</label>
<div>
<input type="text" class="form-control" id="inicio" placeholder="Ingrese sus Datos" maxlength="4"   />
<label class="red bolder hide" id="inicio_validate">El año es Obligatorio   *</label>
</div>

<label for="fin" class="blue bolder">Año de Fin:</label>
<div>
<input type="text" class="form-control" id="fin" placeholder="Ingrese sus Datos" maxlength="4"   />
<label class="red bolder hide" id="fin_validate">El año es Obligatorio   *</label>
</div>

<label for="lema" class="blue bolder">Lema:</label>
<div>
<input type="text" class="form-control" id="lema" placeholder="Ingrese sus Datos" maxlength="200"   />
<label class="red bolder hide" id="lema_validate">El Lema es Obligatorio   *</label>
</div>
				...
				function tooltip_placement(context, source) {
					...
					return 'left';
                                 ...
                                 $("#btnguardar").on("click",function() {
                                     if (validate("#inicio","#inicio_validate")) return;
                                     if (validate("#fin","#fin_validate")) return;
                                     if (validate("#lema","#lema_validate")) return;
...
//                        alert(valores[0]);
                        ...
                        if (respuesta){
                          var parametros={"Eliminar":"-",
                                           "codigoe":valores[0]};
                            eliminar_datos(parametros,"../clases/gestion.php","post");
                        }
                    ...
                    $(".editar").click(function(){
                        ...
                        idedicion=valores[0];
                        $("#inicio").val(valores[1]);
                        $("#fin").val(valores[2]);
                        $("#lema").val(valores[3]);
                    });
    $('document').ready(function (){
                                            $('#mm1').addClass("active open");
                                            $('#mm16').addClass("active");
                                                });
                </script>
