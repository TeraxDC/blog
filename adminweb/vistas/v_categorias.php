				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Categorías de Publicación</li>
						</ul><!-- /.breadcrumb -->
                                                                                                                              ...
                                                                                                                              <div class="col-xs-12">
                                                                                                                                    ...
                                                                                                                                    <div class="table-header">
                                                                                                                                        ...
                                                                                                                                        <table id="tabla_datos" class="table table-striped table-bordered table-hover ">
                                                                                                                                                ...
                                                                                                                                                <tbody>
                                                                                                                                                    <?php
                                                                                                                                                    require_once '../clases/categoria_publicacion.php';
                                                                                                                                                        $dml_categoria_publicacion->lista_tablas();
                                                                                                                                                    ?>
                                                                                                                                                </tbody>
                                                                                                                                        </table>
...
<label for="nombre" class="blue bolder">Nombre de Categoría:</label>
<div>
<input type="text" class="form-control" id="nombre" placeholder="Ingrese sus Datos" maxlength="45"   />
<label class="red bolder hide" id="nombrevalidate">El nombre es Obligatorio   *</label>
</div>
</div>
</div>
</div>
					...
					return 'left';
                                ...
                                //GUARDAR DATOS
                                 $("#btnguardar").on("click",function() {
                                     if (validate("#nombre","#nombrevalidate")) return;
                                    var nombre=$("#nombre").val();
                                    if (idedicion!==""){
//                                        alert(idedicion);
                                        var parametros={"Modificar":"xfrdesdfgas",
                                                    "idcategoria_publicacion":idedicion,
                                                    "nombre":nombre};     
                                    }else{
                                    ...
                                    $.ajax({
                                        data:  parametros,
                                        url:   "../clases/categoria_publicacion.php",
                                        type:  "post",
...
//                        alert(valores[0]);
                        ...
                        if (respuesta){
                          var parametros={"Eliminar":"-",
                                           "codigoe":valores[0]};
                            eliminar_datos(parametros,"../clases/categoria_publicacion.php","post");
                        }
