                                                                                                                              ...
                                                                                                                              <div class="col-xs-12">
                                                                                                                                    ...
                                                                                                                                    <div class="table-header">
                                                                                                                                        ...
                                                                                                                                        <table id="tabla_datos" class="table table-striped table-bordered table-hover ">
                                                                                                                                                ...
                                                                                                                                                <tbody>
                                                                                                                                                    <?php
                                                                                                                                                    require_once '../clases/cat_transparencia.php';
                                                                                                                                                        $dml_cat_transparencia->lista_tablas();
                                                                                                                                                    ?>
                                                                                                                                                </tbody>
                                                                                                                                        </table>
...
<label for="nombre" class="blue bolder">Nombre:</label>
<div>
...
//                                        alert(idedicion);
                                    ...
                                    $.ajax({
                                        data:  parametros,
                                        url:   "../clases/cat_transparencia.php",
                                        type:  "post",
...
//                        alert(valores[0]);
                        ...
                        if (respuesta){
                          var parametros={"Eliminar":"-",
                                           "codigoe":valores[0]};
                            eliminar_datos(parametros,"../clases/cat_transparencia.php","post");
                        }
