                                                                                                                              ...
                                                                                                                              <div class="col-xs-12">
                                                                                                                                    ...
                                                                                                                                    <div class="table-header">
                                                                                                                                        ...
                                                                                                                                        <table id="tabla_datos" class="table table-striped table-bordered table-hover ">
                                                                                                                                                ...
                                                                                                                                                <tbody>
                                                                                                                                                    <?php
                                                                                                                                                    require_once '../clases/sub_categoria.php';
                                                                                                                                                        $dml_sub_categoria->lista_tablas();
                                                                                                                                                    ?>
                                                                                                                                                </tbody>
                                                                                                                                        </table>
...
<label for="idcategoria" class="blue bolder">Categoría:</label>
<div>
<select class="chosen-select form-control" id="idcategoria" name="idcategoria" data-placeholder="Escoja una Cagegoría">
                                                                            <option value=""></option>
									<?php
                                                                              $dml_sub_categoria->lista_categorias();  
                                                                          ?>
</select><br>
<label class="red bolder hide" id="idcategoriavalidate">La Categoría es Obligatorio   *</label>
</div>
<label for="nombre_sub_cat" class="blue bolder">Sub Categoría:</label>
<div>
<input type="text" class="form-control" id="nombre_sub_cat" placeholder="Ingrese sus Datos" maxlength="100"   />
<label class="red bolder hide" id="nombre_sub_catvalidate">La Sub categoría  es Obligatorio   *</label>
</div>
</div>
</div>
</div>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">MUNIHUAYTARA</span>
							SFLV &copy; 2013-2020
						</span>
				...
				function tooltip_placement(context, source) {
					...
					return 'left';
                                 ...
                                 $("#btnguardar").on("click",function() {
                                     if (validate("#idcategoria","#idcategoriavalidate")) return;
                                     if (validate("#nombre_sub_cat","#nombre_sub_catvalidate")) return;
                                    
                                    var idcategoria=$("#idcategoria").val();
                                    var nombre_sub_cat=$("#nombre_sub_cat").val();
                                    if (idedicion!==""){
//                                        alert(idedicion);
                                        var parametros={"Modificar":"xfrdesdfgas",
                                                    "idsub_categoria":idedicion,
...
//                        alert(valores[0]);
                        ...
                        if (respuesta){
                          var parametros={"Eliminar":"-",
                                           "codigoe":valores[0]};
                            eliminar_datos(parametros,"../clases/sub_categoria.php","post");
                        }
                    ...
                    $(".editar").click(function(){
                        ...
                        $("#idcategoria").chosen();
                        idedicion=valores[0];
                        $("#idcategoria").val(valores[3]);
                        $("#idcategoria").trigger("chosen:updated");
                        $("#nombre_sub_cat").val(valores[2]);
                    });
    $('document').ready(function (){
                                            $('#mm1').addClass("active open");
                                            $('#mm9').addClass("active");
                                                });
                </script>
