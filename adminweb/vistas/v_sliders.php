...
<div>
<input type="text" class="form-control" id="titulo" placeholder="Ingrese sus Datos" maxlength="45"   />
<label class="red bolder hide" id="titulovalidate">El Título es Obligatorio   *</label>
</div>
<label for="descripcion" class="blue bolder">Descripción:</label>
<div>
<input type="text" class="form-control" id="descripcion" placeholder="Ingrese sus Datos" maxlength="200"   />
</div>
<label for="texto_boton" class="blue bolder">Texto del Botón:</label>
<div>
<input type="text" class="form-control" id="texto_boton" placeholder="Ingrese sus Datos" maxlength="20"   />
<label class="red bolder hide" id="texto_botonvalidate">El Texto del Botón es Obligatorio   *</label>
</div>
<label for="direccion_boton" class="blue bolder">Dirección del Botón:</label>
<div>
<input type="text" class="form-control" id="direccion_boton" placeholder="Ingrese sus Datos" maxlength="255"   />
<label class="red bolder hide" id="direccion_botonvalidate">El Dirección del Botón es Obligatorio   *</label>
</div>
<label for="f_inicio" class="blue bolder">f_inicio:</label>
<div>
    <input type="date" class="form-control" id="f_inicio"   />
<label class="red bolder hide" id="f_iniciovalidate">El f_inicio es Obligatorio   *</label>
</div>
<label for="f_fin" class="blue bolder">f_fin:</label>
<div>
<input type="date" class="form-control" id="f_fin"   />
<label class="red bolder hide" id="f_finvalidate">El f_fin es Obligatorio   *</label>
</div>
<label for="imagen" class="blue bolder">Seleccione una Imagen de 1920*1200 px:</label>
<div>
<div class="col-xs-12">
    <div id="progressbar" class="hide" ></div>
    <input  type="file" id="imagen" />
    <label class="red bolder hide" id="imagenvalidate">Debe cargar una Imagen   *</label>
</div>
</div>
</div>
</div>
				...
				function tooltip_placement(context, source) {
					...
					return 'left';
                                 ...
                                 $("#btnguardar").on("click",function() {
                                    if (validate("#imagen","#imagenvalidate")) return;
                                    if (validate("#titulo","#titulovalidate")) return;
                                    if (validate("#descripcion","#descripcionvalidate")) return;
                                    if (validate("#texto_boton","#texto_botonvalidate")) return;
                                    if (validate("#direccion_boton","#direccion_botonvalidate")) return;
                                    if (validate("#f_inicio","#f_iniciovalidate")) return;
                                    if (validate("#f_fin","#f_finvalidate")) return;
                                    var titulo =$("#titulo").val();
                                    var descripcion =$("#descripcion").val();
                                    var texto_boton =$("#texto_boton").val();
                                    var direccion_boton =$("#direccion_boton").val();
                                    ...
                                    var fichero=document.getElementById("imagen");
                                     var formData = new FormData();
                                        ...
                                        if (idedicion!=="") {
                                          formData.append("idslider",idedicion);
                                          ...
                                          formData.append("texto_boton",texto_boton);
                                           formData.append("direccion_boton",direccion_boton);
                                            formData.append("f_inicio",f_inicio);
                                             formData.append("f_fin",f_fin);
                                             
                                           $.ajax({
                                                    data: formData,
                                                    url: "../clases/slider.php",
                                                    type: "post",
                                                    dataType: "html",
                                                    cache: false,
                                                    contentType: false,
...
//                        alert(valores[0]);
                        ...
                        if (respuesta){
                          var parametros={"Eliminar":"-",
                                           "codigoe":valores[0]};
                            eliminar_datos(parametros,"../clases/slider.php","post");
                        }
