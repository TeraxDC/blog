      ...
      <div class="container">
        ...
        <header class="section-header">
          <?php
                    ...
                    $publicaciones->obtener_titulo_Cat($idcat)
                    ?>
        </header>
          <div class="row">
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <?php
                    $publicaciones->lista_subcategorias($idcat);
               ?>
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container">
          ...
          <?php
                    $publicaciones->lista_publicaciones($idcat);
          ?>
        ...
        <div class="row no-gutters clients-wrap clearfix wow fadeInUp">
          ...
          <div class="col-lg-3 col-md-4 col-xs-6">
            ...
            <div class="client-logo portal">
                <a href="#"><img src="img/enlaces externos/logo-pt.png" class="img-fluid" alt=""></a>
            </div>
          </div>
            <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="client-logo ">
