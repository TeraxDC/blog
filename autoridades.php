...
<div class="row center">
    <div  class="col-12 notices-header">
        <div class="col-xs-12 col-md-6  data_publish">
            <h3 class="title-autoridades">Alcalde Provincial</h3>
            <h3 class="title-autoridades">Prof. Ricardo Yauricasa Flores</h3>
            <hr class="hr-success" />
            <p>Gestión Edil: 2019 - 2022</p>
        </div>
        <div class="col-xs-12 col-md-5 img-header">
            <img src="img/alcalde/alcalde.jpg"  alt="inkahuasi panoramico"/>
        </div>
</div>  
</div>
    </div>
...
<!--        <header class="section-header">
        ...
        <div class="row text-autoridades">
             <div class="col-xs-12 col-lg-9">
             
                 <p>
                     Quisiera saludar a todo el pueblo Huaytarino y a nuestros seguidores en diversas partes de nuestro país a nombre de nuestros regidores y la Municipalidad Provincial de Huaytará, reitero mi compromiso con nuestra provincia de Huaytará de llevarlo por el camino del progreso, con dedicación y trabajo en equipo, marchando en conjunto con nuestra gente Huaytarina. En nuestra provincia existen necesidades que cubrir, y ya empezamos a hacerlo, estamos trabajando para seguir concretando los objetivos que nos trazamos al inicio de la gestión. 
                 </p>
                 <p>
                    A través de nuestra paginas usted podrá conocer todas las actividades y gestiones que se van desarrollando en este año. Así mismo gracias a este medio estaremos cerca de ustedes resolviendo las inquietudes que se presenten y recibiendo sus propuestas o proyectos que permitan el avance de nuestro distrito.   
                 </p>
                 

             
            </div> 
            <div class="col-xs-12 col-lg-3 fb-section d-none d-md-block">
                <h3>Facebook</h3>
